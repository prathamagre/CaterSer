        ...
        <div class="container-fluid faqt py-6">
            <div class="container">
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-lg-5 wow bounceInUp" data-wow-delay="0.1s">
                        <div class="video">
                            <button type="button" class="btn btn-play" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/jf2no9vSUus?si=UTJXJL_hBIm8-pYV" data-bs-target="#videoModal">
                                <span></span>
                            </button>
                        </div>
                    </div>
                            ...
                            <div class="row g-4 form">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <select class="form-select border-primary p-2" aria-label="Default select example">
                                        ...
                                        <option value="2">Moderate Event</option>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-3 col-md-6 wow bounceInUp" data-wow-delay="0.5s">
                        <div class="team-item rounded">
                            ...
                            <div class="team-content text-center py-3 bg-dark rounded-bottom">
                                <h4 class="text-primary">Rajshree</h4>
                                <p class="text-white mb-0">Dishwasher</p>
                            </div>
                            <div class="team-icon d-flex flex-column justify-content-center m-4">
                                <a class="share btn btn-primary btn-md-square rounded-circle mb-2" href=""><i class="fas fa-share-alt"></i></a>
                                <a class="share-link btn btn-primary btn-md-square rounded-circle mb-2" href=""><i class="fab fa-facebook-f"></i></a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <div class="d-flex flex-column align-items-start">
                                <p><i class="fa fa-map-marker-alt text-primary me-2"></i>Lal ghati Bhopal</p>
                                <p><i class="fa fa-phone-alt text-primary me-2"></i>+91 9876543210</p>
                                <p><i class="fas fa-envelope text-primary me-2"></i>caterserv@gmail.com</p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 my-auto text-center text-md-end text-white">
                        ...
                        Designed By <a class="border-bottom" href="https://krishnapatidar458.netlify.app">Krishna Patidar</a>
                    </div>
                </div>
            </div>
        </div>
